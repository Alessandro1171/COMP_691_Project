...
class StatusIdBrainWav2Vec2(sb.Brain):
    ...
    def compute_objectives(self, predictions, batch, stage):
        ...
        loss = self.hparams.compute_cost(predictions, statusid)
...
def dataio_prep(hparams):
    ...
    def audio_pipeline(wav):
        ...
        max_len = 10 * 16000  # 10 seconds at 16kHz
        if len(sig) > max_len:
          sig = sig[:max_len]
        return sig
...
if __name__ == "__main__":
    ...
    status_id_brain_wav2_vec2 = StatusIdBrainWav2Vec2(
    ...
    status_id_brain_wav2_vec2.fit(
        epoch_counter=status_id_brain_wav2_vec2.hparams.epoch_counter,
    ...
    test_stats = status_id_brain_wav2_vec2.evaluate(
